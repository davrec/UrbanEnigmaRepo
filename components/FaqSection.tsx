      ...
      <div className="container mx-auto flex flex-col items-center w-[80%] sm:w-[60%]">
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-8 w-full">
          ...
          <div className="flex-1 bg-bgScuro p-6 rounded-lg shadow-lg">
            <h4 className="text-2xl font-semibold mb-4 text-white">Che cos&apos;è Urban enigma?</h4>
          ...
          {/* Card 2 */}
          <div className="flex-1 bg-bgScuro p-6 rounded-lg shadow-lg">
            <h4 className="text-2xl font-semibold mb-4 text-white">Come funziona il gioco?</h4>
            <p className="text-lg leading-relaxed">
          ...
          {/* Card 3 */}
          <div className="flex-1 bg-bgScuro p-6 rounded-lg shadow-lg">
            <h4 className="text-2xl font-semibold mb-4 text-white">Quante persone possono partecipare?</h4>
            <p className="text-lg leading-relaxed">
